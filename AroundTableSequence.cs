...
public class AroundTableSequence : SequenceBase
{
    ...
    public AudioClip[] nightlanderOneClips, nightlanderTwoClips, nightlanderThreeClips, nightlanderFourClips, nightlanderFiveClips, protagClips, loopClips;
        ...
        if (finished == 0){
            ...
            if (triggered == 1){
                ...
                if (MovedAwayChecker()){
                    ...
                    audioSourceContainer.protagSource.PlayOneShot(sitDownClip);
                    ...
                    audioSourceContainer.nightlanderFiveSource.PlayOneShot(nightlanderFourClips[1]);
                    ...
                    audioSourceContainer.protagSource.PlayOneShot(slamAndGetUpClip);
