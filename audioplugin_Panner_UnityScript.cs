...
public class audioplugin_PannerGUI : IAudioEffectPluginGUI
{
    public override string Name           { get { return "audioplugin_Panner"; } }
    public override string Description    { get { return "Panner"; } }
    public override string Vendor         { get { return "yourcompany"; } }

    //==============================================================================
	[DllImport("audioplugin_Panner")] static extern System.IntPtr getRenderCallback();

    [DllImport("audioplugin_Panner")] static extern void unityInitialiseTexture (int id, System.IntPtr texture, int width, int height);

    [DllImport("audioplugin_Panner")] static extern void unityMouseDown (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_Panner")] static extern void unityMouseDrag (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_Panner")] static extern void unityMouseUp   (int id, float x, float y, EventModifiers mods);

    [DllImport("audioplugin_Panner")] static extern void unityKeyEvent (int id, KeyCode code, EventModifiers mods, string name);

    [DllImport("audioplugin_Panner")] static extern void unitySetScreenBounds (int id, float x, float y, float w, float h);
